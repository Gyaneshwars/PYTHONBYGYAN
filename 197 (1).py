...
associatedStrings = [{ "id": 17050, "group": 1, "includeFlag": 1, "keyword": "kumar" },{ "id": 17051, "group": 1, "includeFlag": 1, "keyword": ".*Buyers Credit.*" },{ "id": 17050, "group": 2, "includeFlag": 0, "keyword": "Yes" },{ "id": 17050, "group": 1, "includeFlag": 1, "keyword": "Nandu" }]
...
parameters = {
              ...
              "Tag2": [ { "value": "capitalStructureNonRecourseTypeName" } ],
...
def DCS1(historicalData, filingMetadata, extractedData, parameters,data1):
    ...
    #and (gaap_exc=="" or filingMetadata["metadata"]["GAAP"] not in gaap_exc)\
        ...
        df_filtered = df[df[Tag1].apply(lambda s: check_conditions(s, group_1_data)) &
