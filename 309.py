...
associatedStrings = [{ "id": 17050, "group": 1, "includeFlag": 0, "keyword": "Yes" },{ "id": 17050, "group": 3, "includeFlag": 0, "keyword": "No" },{ "id": 17050, "group": 2, "includeFlag": 1, "keyword": "Covered" }]
...
parameters = {
              ...
              "Tag2": [ { "value": "capitalStructureCleanedDescription" } ],
              "Tag3": [ { "value": "capitalStructureNonRecourseTypeName" } ],
...
def DCS1(historicalData, filingMetadata, extractedData, parameters,data1):
    ...
    #and (gaap_exc=="" or filingMetadata["metadata"]["GAAP"] not in gaap_exc)\
        ...
        group_3_data = [item for item in associatedStrings if item['group'] == 3]
        ...
        df_filtered = df[(df[Tag1].apply(lambda s: check_conditions(s, group_1_data)) | df[Tag3].apply(lambda s: check_conditions(s, group_3_data))) &
                        df[Tag2].apply(lambda s: check_conditions(s, group_2_data))]
