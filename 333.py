...
associatedStrings = [{ "id": 17050, "group": 1, "includeFlag": 1, "keyword": "call loans" },{ "id": 17050, "group": 2, "includeFlag": 1, "keyword": "call loans" }]
...
parameters = {
              ...
              "Tag2": [ { "value": "lineItemDescription" } ],
              "LHSTags": [ { "value": "DBOB" } ],
...
def DCS1(historicalData, filingMetadata, extractedData, parameters,data1):
    ...
    #and (gaap_exc=="" or filingMetadata["metadata"]["GAAP"] not in gaap_exc)\
        ...
        df_filtered = df[(~df["dataItemTag"].isin(LHStag))  & (df[Tag1].apply(lambda s: check_conditions(s, group_1_data)) |  df[Tag2].apply(lambda s: check_conditions(s, group_2_data))) ]
